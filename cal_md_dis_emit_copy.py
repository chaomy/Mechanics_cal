...
# @Last Modified time: 2017-08-31 11:13:13
...
class cal_dis_emit(object):
    ...
    def cal_crack(self, param):
        drv = cal_md_crack_ini.md_crack_ini()

        drv.element = self.pot['element']
        drv.c11, drv.c12, drv.c44 = param['c11'], param['c12'], param['c44']
        #  drv.burgers = param['lat'] * np.sqrt(2.) / 2. * np.array([-1., 1., 0])
    ...
    def get_cutin_result_mat_k1e(self, param):
        ...
        soltrace = np.mat([[stroh.p[0], 0.0, 0.0],
                           [0.0, stroh.p[1], 0.0],
                           [0.0, 0.0, stroh.p[2]]], dtype='complex')
