...
# @Last Modified time: 2017-11-01 01:58:44

class cal_md_gb_hcp_gub(object):
	"""docstring for cal_md_gb_hcp_gub"""
	def __init__(self, arg):
		super(cal_md_gb_hcp_gub, self).__init__()
		self.arg = arg

	def build_hcp_gb_bug(self, ang=15, thk = (40, 50), disp=(0, 0, 0)):
	    fid = open("in.gb", 'w')
...
region  whole  block  0.0 &
${xdim} ${ydimmin} ${ydimmax} 0.000000 ${zdim} units box
