...
class cal_add_strain(object):
    ...
    def _volume_conserving_ortho_strain(self, delta):
    ...
    def _volume_conserving_ortho_strain_atoms(self, delta, atoms):
        strain = np.mat([[1 + delta, 0, 0],
                         [0, 1 - delta, 0],
                         [0, 0, 1 / (1 - delta**2)]])
    ...
    def _volume_conserving_mono_strain_atoms(self, delta, atoms):
